...
struct PrecisionHitData {
  PrecisionHitData(RE::Actor* a_attacker, RE::TESObjectREFR* a_target,
                   RE::hkpRigidBody* a_hitRigidBody, RE::hkpRigidBody* a_hittingRigidBody,
                   const RE::NiPoint3& a_hitPos, const RE::NiPoint3& a_separatingNormal,
                   const RE::NiPoint3& a_hitPointVelocity, RE::hkpShapeKey a_hitBodyShapeKey,
                   RE::hkpShapeKey a_hittingBodyShapeKey)
      : attacker(a_attacker), target(a_target), hitRigidBody(a_hitRigidBody),
        hittingRigidBody(a_hittingRigidBody), hitPos(a_hitPos),
        separatingNormal(a_separatingNormal), hitPointVelocity(a_hitPointVelocity),
...
public:
  ...
  /// <returns>OK, AlreadyRegistered</returns>
  virtual APIResult
  AddPrePhysicsStepCallback(SKSE::PluginHandle       a_myPluginHandle,
  ...
  /// <returns>OK, NotRegistered</returns>
  virtual APIResult
  RemoveCollisionFilterComparisonCallback(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;
  ...
  virtual float
  GetAttackCollisionCapsuleLength(RE::ActorHandle              a_actorHandle,
...
public:
  ...
  /// <returns>OK, AlreadyRegistered</returns>
  virtual APIResult
  AddWeaponWeaponCollisionCallback(SKSE::PluginHandle        a_myPluginHandle,
  ...
  /// <returns>OK, NotRegistered</returns>
  virtual APIResult
  RemoveWeaponWeaponCollisionCallback(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;
  ...
  /// <returns>OK, AlreadyRegistered</returns>
  virtual APIResult
  AddWeaponProjectileCollisionCallback(SKSE::PluginHandle        a_myPluginHandle,
                                       WeaponCollisionCallback&& a_callback) noexcept = 0;
  ...
  /// <returns>OK, NotRegistered</returns>
  virtual APIResult
  RemoveWeaponProjectileCollisionCallback(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;

  [[deprecated("Use ApplyHitImpulse2 instead")]] virtual void
  ApplyHitImpulse(RE::ActorHandle a_actorHandle, RE::hkpRigidBody* a_rigidBody,
                  const RE::NiPoint3& a_hitVelocity, const RE::hkVector4& a_hitPosition,
...
public:
  ...
  /// <returns>OK, AlreadyRegistered</returns>
  virtual APIResult
  AddCollisionFilterSetupCallback(SKSE::PluginHandle             a_myPluginHandle,
  ...
  /// <returns>OK, NotRegistered</returns>
  virtual APIResult
  RemoveCollisionFilterSetupCallback(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;
  ...
  IsActorActiveCollisionGroup(uint16_t a_collisionGroup) const noexcept = 0;
  ...
  [[nodiscard]] virtual bool
  IsActorCharacterControllerHittable(RE::ActorHandle a_actorHandle) const noexcept = 0;
  ...
  /// <returns>Whether the character controller is hittable</returns>
  [[nodiscard]] virtual bool
  IsCharacterControllerHittableCollisionGroup(uint16_t a_collisionGroup) const noexcept = 0;
...
public:
  ...
  /// <returns>OK, AlreadyRegistered</returns>
  virtual APIResult
  AddPrecisionLayerSetupCallback(SKSE::PluginHandle            a_myPluginHandle,
  ...
  /// <returns>OK, NotRegistered</returns>
  virtual APIResult
  RemovePrecisionLayerSetupCallback(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;
  ...
  virtual void ApplyHitImpulse2(RE::ActorHandle a_targetActorHandle,
                                RE::ActorHandle a_sourceActorHandle, RE::hkpRigidBody* a_rigidBody,
...
RequestPluginAPI(const InterfaceVersion a_interfaceVersion = InterfaceVersion::V4) {
