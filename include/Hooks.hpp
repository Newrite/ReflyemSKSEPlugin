...
struct OnSomeMenuEquipState final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    get_equip_state_01_ = trampoline.write_call<5>(Adresses::on_some_menu_call_equip_slot_01.address() +
                                                       Offsets::on_some_menu_call_equip_slot_01,
                                                   get_equip_state_01);
    get_equip_state_02_ = trampoline.write_call<5>(Adresses::on_some_menu_call_equip_slot_02.address() +
                                                       Offsets::on_some_menu_call_equip_slot_02,
                                                   get_equip_state_01);
    get_equip_state_03_ = trampoline.write_call<5>(Adresses::on_some_menu_call_equip_slot_03.address() +
                                                       Offsets::on_some_menu_call_equip_slot_03,
                                                   get_equip_state_01);
...
struct OnSomeEquip final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    some_equip_ = trampoline.write_call<5>(Adresses::on_some_equip.address() + Offsets::on_some_equip, some_equip);
    some_equip_default_equip_ = trampoline.write_call<5>(
        Adresses::on_some_equip.address() + Offsets::on_some_equip_default_slot, some_equip_default_equip);
    logger::info("finish hook OnSomeEquip"sv);
  }

  private:
  static auto some_equip(RE::ActorEquipManager* equip_manager,
                         RE::Actor* actor,
                         RE::TESBoundObject* bound_object,
                         void* extra_data_list) -> void;
  static auto some_equip_default_equip(RE::ActorEquipManager* equip_manager,
                                       RE::Actor* actor,
