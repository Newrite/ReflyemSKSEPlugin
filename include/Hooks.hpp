...
static inline REL::Relocation<uintptr_t> on_sneak_requirement_for_sneak_attack{RELOCATION_ID(42844, 0)};
...
static inline REL::Relocation<uintptr_t> on_equip_manager_equip_spell{RELOCATION_ID(37973, 0)};
static inline REL::Relocation<uintptr_t> on_equip_manager_equip_shout{RELOCATION_ID(37941, 0)};
...
static inline REL::Relocation<uintptr_t> on_apply_voice_ability{RELOCATION_ID(41356, 0)};
static inline REL::Relocation<uintptr_t> on_equip_spell_D7{RELOCATION_ID(37952, 0)};
...
static inline REL::Relocation<uintptr_t> on_favorite_menu_equip_state_01{RELOCATION_ID(50650, 0)};
static inline REL::Relocation<uintptr_t> on_favorite_menu_equip_state_02{RELOCATION_ID(50657, 0)};
static inline REL::Relocation<uintptr_t> on_favorite_menu_equip_state_03{RELOCATION_ID(50659, 0)};
static inline REL::Relocation<uintptr_t> on_spell_equip_menu{RELOCATION_ID(51164, 0)};
static inline REL::Relocation<uintptr_t> on_decrement_poison_count_get_poison_item{RELOCATION_ID(15762, 0)};
static inline REL::Relocation<uintptr_t> on_poison_object{RELOCATION_ID(39407, 0)};
static inline REL::Relocation<uintptr_t> on_poison_prompt{RELOCATION_ID(36976, 0)};
static inline REL::Relocation<uintptr_t> on_spell_equip_menu_favorite{RELOCATION_ID(50654, 0)};
static inline REL::Relocation<uintptr_t> on_actor_equip_manager_equip_object{RELOCATION_ID(37938, 0)};
...
static inline REL::Relocation<uintptr_t> on_apply_spells_from_attack2{RELOCATION_ID(37633, 0)};
...
static inline REL::Relocation<uintptr_t> on_regeneration_stamina_calculate_const_delta{RELOCATION_ID(40356, 0)};
...
static inline REL::Relocation<uintptr_t> on_actor_value_for_cost_during_cast{RELOCATION_ID(33362, 0)};
static inline REL::Relocation<uintptr_t> on_calculate_current_cost_concentration{RELOCATION_ID(33362, 0)};
static inline REL::Relocation<uintptr_t> on_actor_value_for_cost_check_cast{RELOCATION_ID(33364, 0)};
static inline REL::Relocation<uintptr_t> on_actor_value_for_cost_restore_value{RELOCATION_ID(33359, 0)};
...
static inline REL::Relocation<uintptr_t> on_absorb_effect_modify_actor_value{RELOCATION_ID(257544, 0)};
...
static inline REL::Relocation<uintptr_t> on_actor_remove_item_npc{RELOCATION_ID(261397, 0)};
static inline REL::Relocation<uintptr_t> on_actor_remove_item_ref{RELOCATION_ID(235511, 0)};
static inline REL::Relocation<uintptr_t> on_actor_add_object_pc{RELOCATION_ID(261916, 0)};
static inline REL::Relocation<uintptr_t> on_actor_add_object_npc{RELOCATION_ID(261397, 0)};
static inline REL::Relocation<uintptr_t> on_actor_add_object_ref{RELOCATION_ID(235511, 0)};
static inline REL::Relocation<uintptr_t> on_actor_remove_item_pc{RELOCATION_ID(261916, 0)};
...
static inline REL::Relocation<uintptr_t> on_get_attack_cost{RELOCATION_ID(37650, 0)};
static inline REL::Relocation<uintptr_t> on_get_bow_power{RELOCATION_ID(42928, 0)};
static inline REL::Relocation<uintptr_t> on_inventory_open{
    RELOCATION_ID(50239,
                  0)}; // thx Fenix31415! https://github.com/fenix31415/DeathLoseLoot/blob/master/src/main.cpp#L134
static inline REL::Relocation<uintptr_t> on_value_owner_get_actor_value_npc{RELOCATION_ID(261402, 0)};
static inline REL::Relocation<uintptr_t> on_value_owner_set_actor_value_npc{RELOCATION_ID(261402, 0)};
static inline REL::Relocation<uintptr_t> on_value_owner_mod_actor_value_npc{RELOCATION_ID(261402, 0)};
static inline REL::Relocation<uintptr_t> on_value_owner_get_actor_value_pc{RELOCATION_ID(261921, 0)};
static inline REL::Relocation<uintptr_t> on_value_owner_set_actor_value_pc{RELOCATION_ID(261921, 0)};
static inline REL::Relocation<uintptr_t> on_value_owner_mod_actor_value_pc{RELOCATION_ID(261921, 0)};
static inline REL::Relocation<uintptr_t> on_allow_character_magicka_regen{RELOCATION_ID(37831, 0)};
static inline REL::Relocation<uintptr_t> on_arrow_projectile_hit{
    RE::VTABLE_ArrowProjectile[0]}; // from dTry's Valhalla Combat
static inline REL::Relocation<uintptr_t> on_missile_projectile_hit{
    RE::VTABLE_MissileProjectile[0]}; // from dTry's Valhalla Combat
static inline REL::Relocation<uintptr_t> on_cone_projectile_hit{RE::VTABLE_ConeProjectile[0]};
static inline REL::Relocation<uintptr_t> on_flame_projectile_hit{RE::VTABLE_FlameProjectile[0]};
static inline REL::Relocation<uintptr_t> on_beam_projectile_hit{RE::VTABLE_BeamProjectile[0]};
} // namespace Adresses
...
static inline auto on_sneak_requirement_for_sneak_attack = RELOCATION_OFFSET(0x1A9, 0);
static inline auto on_get_combat_style_for_offensive = RELOCATION_OFFSET(0xE, 0);
...
static inline auto on_equip_manager_equip_spell = RELOCATION_OFFSET(0x232, 0);
static inline auto on_equip_manager_equip_shout = RELOCATION_OFFSET(0x21, 0);
...
static inline auto on_is_blocking_in_hit = RELOCATION_OFFSET(0x231, 0);
static inline auto on_favorite_menu_equip_state_01 = RELOCATION_OFFSET(0x1DC, 0);
static inline auto on_magic_hit_first = RELOCATION_OFFSET(0x216, 0);
static inline auto on_magic_hit_two = RELOCATION_OFFSET(0x31C, 0);
static inline auto on_favorite_menu_equip_state_02 = RELOCATION_OFFSET(0x16B, 0);
static inline auto on_favorite_menu_equip_state_03 = RELOCATION_OFFSET(0x161, 0);
...
static inline auto on_actor_equip_manager_equip_object = RELOCATION_OFFSET(0xE5, 0);
static inline auto on_actor_equip_manager_equip_object_default_slot = RELOCATION_OFFSET(0x7F, 0);
...
static inline auto on_apply_spells_from_attack2 = RELOCATION_OFFSET(0xC99, 0);
static inline auto on_calculate_current_cost_concentration = RELOCATION_OFFSET(0x1A3, 0);
...
static inline auto on_decrement_poison_count_get_poison_item = RELOCATION_OFFSET(0x1A, 0);
static inline auto on_poison_object = RELOCATION_OFFSET(0x106, 0);
static inline auto on_poison_prompt = RELOCATION_OFFSET(0x7A8, 0);
...
static inline auto on_actor_add_object_npc = RELOCATION_OFFSET(0x5A, 0);
static inline auto on_actor_add_object_ref = RELOCATION_OFFSET(0x5A, 0);
static inline auto on_actor_remove_item_pc = RELOCATION_OFFSET(0x56, 0);
static inline auto on_actor_remove_item_ref = RELOCATION_OFFSET(0x56, 0);
static inline auto on_apply_voice_ability = RELOCATION_OFFSET(0xDD, 0);
static inline auto on_actor_remove_item_npc = RELOCATION_OFFSET(0x56, 0);
...
static inline auto on_inventory_open =
    RELOCATION_OFFSET(0x13,
                      0); // thx Fenix31415! https://github.com/fenix31415/DeathLoseLoot/blob/master/src/main.cpp#L134
...
static inline auto on_arrow_projectile_hit = RELOCATION_OFFSET(190, 0);
static inline auto on_missile_projectile_hit = RELOCATION_OFFSET(190, 0);
static inline auto on_cone_projectile_hit = RELOCATION_OFFSET(190, 0);
static inline auto on_beam_projectile_hit = RELOCATION_OFFSET(190, 0);
static inline auto on_flame_projectile_hit = RELOCATION_OFFSET(190, 0);
} // namespace Offsets

namespace Hooks {

struct PoisonReworkVisitor final : public RE::InventoryChanges::IItemChangeVisitor
{

  static auto handle_extra_data_list(RE::ExtraDataList* list, const bool force_remove = false) -> bool
  {
    if (!list) {
      return false;
    }

    let poison_data = list->GetByType<RE::ExtraPoison>();
    if (poison_data) {

      if (force_remove) {
        logi("Force remove poison"sv);
        poison_data->count = 0;
        list->Remove(RE::ExtraPoison::EXTRADATATYPE, poison_data);
        return true;
      }

      if (poison_data->count - 1 > 0) {
        logi("Decrease poison"sv);
        poison_data->count = poison_data->count - 1;
        return true;
      }

      poison_data->count = poison_data->count - 1;
      logi("Remove poison"sv);
      list->Remove(RE::ExtraPoison::EXTRADATATYPE, poison_data);
      return true;
    }
  ...
  RE::BSContainer::ForEachResult Visit(RE::InventoryEntryData* entry_data) override
  {

    if (!entry_data || !entry_data->IsPoisoned()) {
      return RE::BSContainer::ForEachResult::kContinue;
    }

    const auto end = entry_data->extraLists->end();
    for (auto it = entry_data->extraLists->begin(); it != end; ++it) {
      auto list = *it;
      if (!list) {
        continue;
      }
      if (handle_extra_data_list(list)) {
        return RE::BSContainer::ForEachResult::kContinue;
      }
...
struct OnCharacterUpdate final
{
  ...
  static auto install_hook() -> void
  {
    ...
    update_npc_ = Adresses::on_actor_update_npc.write_vfunc(Offsets::on_actor_update_npc, update_npc);
...
struct OnProjectileHit final
{
  public:
  static auto install_hook() -> void
  {
    logger::info("start hook OnProjectileHit"sv);
    arrow_handle_hit_ =
        Adresses::on_arrow_projectile_hit.write_vfunc(Offsets::on_arrow_projectile_hit, arrow_handle_hit);
    missile_handle_hit_ =
        Adresses::on_missile_projectile_hit.write_vfunc(Offsets::on_missile_projectile_hit, missile_handle_hit);
    cone_handle_hit_ = Adresses::on_cone_projectile_hit.write_vfunc(Offsets::on_cone_projectile_hit, cone_handle_hit);
    beam_handle_hit_ = Adresses::on_beam_projectile_hit.write_vfunc(Offsets::on_beam_projectile_hit, beam_handle_hit);
    flame_handle_hit_ =
        Adresses::on_flame_projectile_hit.write_vfunc(Offsets::on_flame_projectile_hit, flame_handle_hit);
    logger::info("finish hook OnProjectileHit"sv);
  }

  private:
  static auto arrow_handle_hit(RE::ArrowProjectile* arrow, RE::hkpAllCdPointCollector* collidable_collector) -> void;
  static auto missile_handle_hit(RE::MissileProjectile* missle, RE::hkpAllCdPointCollector* collidable_collector)
      -> void;
  static auto cone_handle_hit(RE::ConeProjectile* cone, RE::hkpAllCdPointCollector* collidable_collector) -> void;
  static auto beam_handle_hit(RE::BeamProjectile* beam, RE::hkpAllCdPointCollector* collidable_collector) -> void;
  static auto flame_handle_hit(RE::FlameProjectile* flame, RE::hkpAllCdPointCollector* collidable_collector) -> void;

  static inline REL::Relocation<decltype(arrow_handle_hit)> arrow_handle_hit_;
  static inline REL::Relocation<decltype(missile_handle_hit)> missile_handle_hit_;
  static inline REL::Relocation<decltype(cone_handle_hit)> cone_handle_hit_;
  static inline REL::Relocation<decltype(beam_handle_hit)> beam_handle_hit_;
  static inline REL::Relocation<decltype(flame_handle_hit)> flame_handle_hit_;
};
...
struct OnActorUpdateEquipBound final
{
  ...
  static auto install_hook() -> void
  {
    ...
    process_event_ = Adresses::on_bound_equip_change.write_vfunc(Offsets::on_bound_equip_change, process_event);
    logger::info("finish hook OnActorUpdateEquipBound"sv);
  }

  private:
  static auto process_event(const RE::ActorInventoryEvent* event,
...
struct OnContainerMenu final
{
  ...
  static auto install_hook() -> void
  {
    ...
    accept_ = Adresses::on_container_menu.write_vfunc(Offsets::on_container_menu_accept, accept);
...
struct OnStandardItemData final
{
  ...
  private:
  static auto get_equip_state(RE::StandardItemData* this_) -> std::uint32_t;
...
struct OnActorMagicCaster final
{
  ...
  static auto install_hook() -> void
  {
    ...
    on_set_spell_impl_ = Adresses::on_set_spell_impl.write_vfunc(Offsets::on_set_spell_impl, on_set_spell_impl);
...
struct OnActorAddRemoveItems final
{
  public:
  static auto install_hook() -> void
  {
    ...
    add_object_to_container_ =
        Adresses::on_actor_add_object_pc.write_vfunc(Offsets::on_actor_add_object_pc, add_object_to_container);
    add_object_to_container_npc_ =
        Adresses::on_actor_add_object_npc.write_vfunc(Offsets::on_actor_add_object_npc, add_object_to_container_npc);
    add_object_to_container_ref_ =
        Adresses::on_actor_add_object_ref.write_vfunc(Offsets::on_actor_add_object_ref, add_object_to_container_ref);
    pick_up_object_ =
        Adresses::on_actor_pickup_object_pc.write_vfunc(Offsets::on_actor_pickup_object_pc, pick_up_object);
    remove_item_ = Adresses::on_actor_remove_item_pc.write_vfunc(Offsets::on_actor_remove_item_pc, remove_item);
    remove_item_npc_ =
        Adresses::on_actor_remove_item_npc.write_vfunc(Offsets::on_actor_remove_item_npc, remove_item_npc);
    remove_item_ref_ =
        Adresses::on_actor_remove_item_ref.write_vfunc(Offsets::on_actor_remove_item_ref, remove_item_ref);
    logger::info("finish hook OnActorAddObject"sv);
  }

  private:
  static auto add_object_to_container(RE::Actor* this_,
                                      RE::TESBoundObject* object,
                                      RE::ExtraDataList* extra_list,
                                      int32_t count,
                                      RE::TESObjectREFR* from_refr) -> void;
  static auto add_object_to_container_ref(RE::TESObjectREFR* this_,
                                          RE::TESBoundObject* object,
                                          RE::ExtraDataList* extra_list,
                                          int32_t count,
                                          RE::TESObjectREFR* from_refr) -> void;
  static auto add_object_to_container_npc(RE::Actor* this_,
                                          RE::TESBoundObject* object,
                                          RE::ExtraDataList* extra_list,
                                          int32_t count,
                                          RE::TESObjectREFR* from_refr) -> void;
  static auto pick_up_object(RE::Actor* this_,
                             RE::TESObjectREFR* ref_object,
                             int32_t count,
                             bool arg3 = false,
                             bool play_sound = true) -> void;
  static auto remove_item(RE::Actor* this_,
  ...
  static auto remove_item_npc(RE::Actor* this_,
                              RE::TESBoundObject* item,
                              std::int32_t count,
                              RE::ITEM_REMOVE_REASON reason,
                              RE::ExtraDataList* extra_list,
                              ...
                              const RE::NiPoint3* drop_loc,
                              const RE::NiPoint3* rotate) -> RE::ObjectRefHandle;
  static auto remove_item_ref(RE::TESObjectREFR* this_,
                              RE::TESBoundObject* item,
                              std::int32_t count,
                              RE::ITEM_REMOVE_REASON reason,
                              RE::ExtraDataList* extra_list,
  ...
  static inline REL::Relocation<decltype(add_object_to_container_npc)> add_object_to_container_npc_;
  static inline REL::Relocation<decltype(add_object_to_container_ref)> add_object_to_container_ref_;
  ...
  static inline REL::Relocation<decltype(remove_item_npc)> remove_item_npc_;
  static inline REL::Relocation<decltype(remove_item_ref)> remove_item_ref_;
};
...
struct OnDrinkPotion final
{
  ...
  static auto install_hook() -> void
  {
    ...
    drink_potion_ = Adresses::on_drink_potion_pc.write_vfunc(Offsets::on_drink_potion_pc, drink_potion);
    logger::info("finish hook OnActorDrinkPotion"sv);
  }

  private:
  static auto drink_potion(RE::Actor* this_, RE::AlchemyItem* potion, RE::ExtraDataList* extra_data_list) -> bool;

  static inline REL::Relocation<decltype(drink_potion)> drink_potion_;
};

struct OnShoutHandler final
{
  public:
  static auto install_hook() -> void
  {
    logger::info("start hook OnShoutHandler"sv);
    process_button_ =
        Adresses::on_shout_handler_vtable.write_vfunc(Offsets::on_shout_handler_process_button, process_button);
    logger::info("finish hook OnShoutHandler"sv);
  }

  private:
  static auto process_button(RE::ShoutHandler* handler,
                             RE::ButtonEvent* button_event,
                             RE::PlayerControlsData* controls_data) -> void;

  static inline REL::Relocation<decltype(process_button)> process_button_;
};
...
struct OnSetCurrentSpell final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    set_spell_impl_pc_ = trampoline.write_call<5>(
        Adresses::on_set_current_spell_pc.address() + Offsets::on_set_current_spell_pc, set_spell_impl_pc);
    set_spell_impl_block_ = trampoline.write_call<5>(
        Adresses::on_set_current_spell_block.address() + Offsets::on_set_current_spell_block, set_spell_impl_block);
    set_spell_impl_FUN_ = trampoline.write_call<5>(
        Adresses::on_set_current_spell_FUN.address() + Offsets::on_set_current_spell_FUN, set_spell_impl_fun);
    logger::info("finish hook OnSetCurrentSpell"sv);
  }

  private:
  static auto set_spell_impl_pc(RE::ActorMagicCaster* caster,
                                RE::MagicItem* magic_item,
                                RE::TESObjectREFR* ref,
                                bool a4) -> bool;
  static auto set_spell_impl_block(RE::ActorMagicCaster* caster,
                                   RE::MagicItem* magic_item,
                                   RE::TESObjectREFR* ref,
                                   bool a4) -> bool;
  static auto set_spell_impl_fun(RE::ActorMagicCaster* caster,
                                 RE::MagicItem* magic_item,
                                 RE::TESObjectREFR* ref,
                                 bool a4) -> bool;
...
struct OnPoisonRework final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnPoisonRework"sv);
    get_poison_item_for_decrement_ =
        trampoline.write_call<5>(Adresses::on_decrement_poison_count_get_poison_item.address() +
                                     Offsets::on_decrement_poison_count_get_poison_item,
                                 get_poison_item_for_decrement);
    poison_object_ =
        trampoline.write_call<5>(Adresses::on_poison_object.address() + Offsets::on_poison_object, poison_object);
    poison_prompt_ =
        trampoline.write_call<5>(Adresses::on_poison_prompt.address() + Offsets::on_poison_prompt, poison_prompt);
    logger::info("finish hook OnPoisonRework"sv);
  }

  private:
  static auto get_poison_item_for_decrement(RE::ExtraDataList* list) -> RE::AlchemyItem*;
  static auto poison_object(RE::InventoryEntryData* data, RE::AlchemyItem* poison, int count) -> void;
  static auto poison_prompt(RE::Actor* actor, RE::AlchemyItem* poison) -> void;

  static inline REL::Relocation<decltype(get_poison_item_for_decrement)> get_poison_item_for_decrement_;
  static inline REL::Relocation<decltype(poison_object)> poison_object_;
  static inline REL::Relocation<decltype(poison_prompt)> poison_prompt_;
};
...
struct OnFavoriteMenuEquipState final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnFavoriteMenuEquipState"sv);
    get_equip_state_01_ = trampoline.write_call<5>(Adresses::on_favorite_menu_equip_state_01.address() +
                                                       Offsets::on_favorite_menu_equip_state_01,
                                                   get_equip_state_01);
    get_equip_state_02_ = trampoline.write_call<5>(Adresses::on_favorite_menu_equip_state_02.address() +
                                                       Offsets::on_favorite_menu_equip_state_02,
                                                   get_equip_state_01);
    get_equip_state_03_ = trampoline.write_call<5>(Adresses::on_favorite_menu_equip_state_03.address() +
                                                       Offsets::on_favorite_menu_equip_state_03,
                                                   get_equip_state_01);
    logger::info("finish hook OnFavoriteMenuEquipState"sv);
  }

  private:
  static auto get_equip_state_01(RE::Actor* actor, RE::TESBoundObject* object, void* a3, void* a4) -> std::uint32_t;
  static auto get_equip_state_02(RE::Actor* actor, RE::TESBoundObject* object, void* a3, void* a4) -> std::uint32_t;
  static auto get_equip_state_03(RE::Actor* actor, RE::TESBoundObject* object, void* a3, void* a4) -> std::uint32_t;
...
struct OnSpellEquip final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    equip_spell_left_ =
        trampoline.write_call<5>(Adresses::on_spell_equip.address() + Offsets::on_spell_equip_left, equip_spell_left);
    equip_spell_right_ =
        trampoline.write_call<5>(Adresses::on_spell_equip.address() + Offsets::on_spell_equip_right, equip_spell_right);
    logger::info("finish hook OnSpellEquip"sv);
  }

  private:
  static auto equip_spell_left(RE::Actor* actor, RE::Actor::SlotTypes slot_type, RE::MagicItem* magic_item) -> void;
  static auto equip_spell_right(RE::Actor* actor, RE::Actor::SlotTypes slot_type, RE::MagicItem* magic_item) -> void;
...
struct OnActorEquipManager final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnActorEquipManager"sv);
    some_equip_ = trampoline.write_call<5>(Adresses::on_actor_equip_manager_equip_object.address() +
                                               Offsets::on_actor_equip_manager_equip_object,
                                           equip_object);
    some_equip_default_equip_ = trampoline.write_call<5>(Adresses::on_actor_equip_manager_equip_object.address() +
                                                             Offsets::on_actor_equip_manager_equip_object_default_slot,
                                                         equip_object_default_slot);
    logger::info("finish hook OnActorEquipManager"sv);
  }

  private:
  static auto equip_object(RE::ActorEquipManager* equip_manager,
                           RE::Actor* actor,
                           RE::TESBoundObject* bound_object,
                           ExtraData* extra_data) -> void;
  static auto equip_object_default_slot(RE::ActorEquipManager* equip_manager,
                                        RE::Actor* actor,
                                        RE::TESBoundObject* bound_object) -> RE::BGSEquipSlot*;
  static inline REL::Relocation<decltype(equip_object)> some_equip_;
  static inline REL::Relocation<decltype(equip_object_default_slot)> some_equip_default_equip_;
};

struct OnActorEquipManagerEquipSpell final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnActorEquipManagerEquipSpell"sv);
    equip_spell_ = trampoline.write_call<5>(
        Adresses::on_equip_manager_equip_spell.address() + Offsets::on_equip_manager_equip_spell, equip_spell);
    logger::info("finish hook OnActorEquipManagerEquipSpell"sv);
  }

  private:
  static auto equip_spell(RE::ActorEquipManager* equip_manager,
                          RE::Actor* actor,
...
struct OnActorEquipManagerEquipShout final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnActorEquipManagerEquipShout"sv);
    equip_shout_ = trampoline.write_call<5>(
        Adresses::on_equip_manager_equip_shout.address() + Offsets::on_equip_manager_equip_shout, equip_shout);
    logger::info("finish hook OnActorEquipManagerEquipShout"sv);
  }

  private:
  static auto equip_shout(RE::ActorEquipManager* equip_manager, RE::Actor* actor, RE::TESShout* shout, void* a4)
      -> void;
  static inline REL::Relocation<decltype(equip_shout)> equip_shout_;
};

struct OnEquipSpell47C5D7 final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnEquipSpell47C5D7"sv);
    equip_spell_47_ =
        trampoline.write_call<5>(Adresses::on_equip_spell_47.address() + Offsets::on_equip_spell_47, equip_spell_47);
    equip_spell_C5_ =
        trampoline.write_call<5>(Adresses::on_equip_spell_C5.address() + Offsets::on_equip_spell_C5, equip_spell_47);
    equip_spell_D7_ =
        trampoline.write_call<5>(Adresses::on_equip_spell_D7.address() + Offsets::on_equip_spell_D7, equip_spell_47);
    papyrus_equip_spell_ = trampoline.write_branch<5>(
        Adresses::on_papyrus_equip_spell.address() + Offsets::on_papyrus_equip_spell, papyrus_equip_spell);
    logger::info("finish hook OnEquipSpell47C5D7"sv);
  }

  private:
  static auto equip_spell_47(RE::ActorEquipManager* equip_manager,
                             RE::Actor* actor,
                             RE::TESBoundObject* bound_item,
                             RE::BGSEquipSlot* equip_slot) -> void;
  static inline REL::Relocation<decltype(equip_spell_47)> equip_spell_47_;
  static auto equip_spell_C5(RE::ActorEquipManager* equip_manager,
                             RE::Actor* actor,
                             RE::TESBoundObject* spell_item,
                             RE::BGSEquipSlot* equip_slot) -> void;
  static inline REL::Relocation<decltype(equip_spell_C5)> equip_spell_C5_;
  static auto equip_spell_D7(RE::ActorEquipManager* equip_manager,
                             RE::Actor* actor,
                             RE::TESBoundObject* spell_item,
                             RE::BGSEquipSlot* equip_slot) -> void;
  static inline REL::Relocation<decltype(equip_spell_D7)> equip_spell_D7_;
  static auto papyrus_equip_spell(RE::ActorEquipManager* equip_manager,
                                  RE::Actor* actor,
                                  RE::TESBoundObject* spell_item,
                                  RE::MagicSystem::CastingSource source) -> void;
  static inline REL::Relocation<decltype(papyrus_equip_spell)> papyrus_equip_spell_;
};
...
struct OnFillCasterEnchantData final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    fill_caster_enchant_data_ = trampoline.write_call<5>(Adresses::on_fill_actor_caster_enchant_data.address() +
...
struct OnEquipSpellMenu final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    equip_spell_menu_ = trampoline.write_call<5>(Adresses::on_spell_equip_menu.address() + Offsets::on_spell_equip_menu,
                                                 equip_spell_menu);
    equip_spell_menu_favorite_ = trampoline.write_call<5>(Adresses::on_spell_equip_menu_favorite.address() +
                                                              Offsets::on_spell_equip_menu_favorite,
                                                          equip_spell_menu_favorite);
    logger::info("finish hook OnEquipSpellMenu"sv);
  }

  private:
  static auto equip_spell_menu(RE::ActorEquipManager* equip_manager,
                               RE::Actor* actor,
                               RE::TESBoundObject* bound_object,
                               RE::BGSEquipSlot* equip_slot) -> RE::BGSEquipSlot*;
  static auto equip_spell_menu_favorite(RE::ActorEquipManager* equip_manager,
                                        RE::Actor* actor,
                                        RE::TESBoundObject* bound_object,
                                        RE::BGSEquipSlot* equip_slot) -> RE::BGSEquipSlot*;
...
struct OnMagicHit final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnMagicHit"sv);
    on_magic_hit_01_ =
        trampoline.write_call<5>(Adresses::on_magic_hit_first.address() + Offsets::on_magic_hit_first, on_magic_hit_01);
    on_magic_hit_02_ =
        trampoline.write_call<5>(Adresses::on_magic_hit_two.address() + Offsets::on_magic_hit_two, on_magic_hit_02);
    logger::info("finish hook OnMagicHit"sv);
  }

  private:
  static auto on_magic_hit_01(RE::MagicCaster* magic_caster,
                              ...
                              bool a7,
                              bool a8) -> void;
  static auto on_magic_hit_02(RE::MagicCaster* magic_caster,
                              RE::NiPoint3* ni_point3,
                              RE::Projectile* projectile,
                              RE::TESObjectREFR* refr_target,
                              float a5,
                              ...
                              bool a7,
                              bool a8) -> void;
  static inline REL::Relocation<decltype(on_magic_hit_01)> on_magic_hit_01_;
  static inline REL::Relocation<decltype(on_magic_hit_02)> on_magic_hit_02_;
};
...
struct OnActorIsOverEncumbered final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    is_actor_on_mount_ = trampoline.write_call<5>(
        Adresses::on_check_mount_in_encumbered.address() + Offsets::on_check_mount_in_encumbered, is_actor_on_mount);
...
struct OnGetCombatStyleForCheckOffensiveMult final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnGetCombatStyleForCheckOffensiveMult"sv);
    get_combat_style_ = trampoline.write_call<5>(Adresses::on_get_combat_style_for_offensive.address() +
                                                     Offsets::on_get_combat_style_for_offensive,
                                                 get_combat_style);
    get_combat_style2_ = trampoline.write_call<5>(Adresses::on_get_combat_style_for_offensive_2.address() +
                                                      Offsets::on_get_combat_style_for_offensive_2,
                                                  get_combat_style2);
    logger::info("finish hook OnGetCombatStyleForCheckOffensiveMult"sv);
  }

  private:
  static auto get_combat_style(RE::Character* character) -> RE::TESCombatStyle*;
  static auto get_combat_style2(RE::Character* character) -> RE::TESCombatStyle*;
  static inline REL::Relocation<decltype(get_combat_style)> get_combat_style_;
  static inline REL::Relocation<decltype(get_combat_style)> get_combat_style2_;
};
...
struct OnCalculatePlayerSprintCost final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    calculate_sprint_cost_ = trampoline.write_call<5>(
        Adresses::on_calculate_sprint_cost.address() + Offsets::on_calculate_sprint_cost, calculate_sprint_cost);
...
struct OnInventoryOpen final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    is_displayed_item_ =
        trampoline.write_call<5>(Adresses::on_inventory_open.address() + Offsets::on_inventory_open, is_displayed_item);
...
struct OnGetAttackCost final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnGetAttackCost"sv);
    get_attack_cost_ =
        trampoline.write_call<5>(Adresses::on_get_attack_cost.address() + Offsets::on_get_attack_cost, get_attack_cost);
    logger::info("finish hook OnGetAttackCost"sv);
  }

  private:
  static auto get_attack_cost(RE::ActorValueOwner* owner, RE::BGSAttackData* attack_data) -> float;
  static inline REL::Relocation<decltype(get_attack_cost)> get_attack_cost_;
};
...
struct OnApplySpellsFromAttack final
{
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    apply_spells_from_attack_ =
        trampoline.write_call<5>(Adresses::on_apply_spells_from_attack.address() + Offsets::on_apply_spells_from_attack,
                                 apply_spells_from_attack);
    // apply_spells_from_attack2_ =
    //     trampoline.write_call<5>(Adresses::on_apply_spells_from_attack2.address() +
    //     Offsets::on_apply_spells_from_attack2,
    //                              apply_spells_from_attack2);
    logger::info("finish hook OnApplySpellsFromAttack"sv);
  }

  static auto apply_spells_from_attack(RE::Character* attacker,
  ...
  // static auto apply_spells_from_attack2(RE::Actor* attacker,
  //                                    RE::SpellItem* spell,
  //                                    RE::Actor* target) -> void;
  // static inline REL::Relocation<decltype(apply_spells_from_attack2)> apply_spells_from_attack2_;
};
...
struct OnRegenerationPermanentValue final
{
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    calculate_regeneration_value_health_ = trampoline.write_call<5>(
        Adresses::on_regeneration_health.address() + Offsets::on_calculate_regeneration_health_magicka,
        calculate_regeneration_value_health);
    calculate_regeneration_value_magicka_ = trampoline.write_call<5>(
        Adresses::on_regeneration_magicka.address() + Offsets::on_calculate_regeneration_health_magicka,
        calculate_regeneration_value_magicka);
    calculate_regeneration_value_stamina_const_delta_ =
        trampoline.write_call<5>(Adresses::on_regeneration_stamina_calculate_const_delta.address() +
    ...
    calculate_regeneration_value_stamina_ = trampoline.write_call<5>(
        Adresses::on_regeneration_stamina_calculate.address() + Offsets::on_regeneration_stamina_calculate,
        calculate_regeneration_value_stamina);
    logger::info("finish hook OnRegenerationPermanentValue"sv);
  }

  static auto calculate_regeneration_value_health(RE::Character* character, RE::ActorValue av) -> float;
  static auto calculate_regeneration_value_magicka(RE::Character* character, RE::ActorValue av) -> float;
  static auto calculate_regeneration_value_stamina_const_delta(RE::Actor* actor, float delta) -> void;
  static auto calculate_regeneration_value_stamina(RE::Actor* actor, float delta) -> void;
  static inline REL::Relocation<decltype(calculate_regeneration_value_health)> calculate_regeneration_value_health_;
  static inline REL::Relocation<decltype(calculate_regeneration_value_magicka)> calculate_regeneration_value_magicka_;
...
struct OnArrowCallHit final
{
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    arrow_call_hit_ =
        trampoline.write_call<5>(Adresses::on_arrow_call_hit.address() + Offsets::on_arrow_call_hit, arrow_call_hit);
...
struct OnAttackIsBlocked final
{
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    is_blocked_ = trampoline.write_call<5>(Adresses::on_is_blocked.address() + Offsets::on_is_blocked, is_blocked);
    is_blocking_in_hit_ = trampoline.write_call<5>(
        Adresses::on_is_blocking_in_hit.address() + Offsets::on_is_blocking_in_hit, is_blocking_in_hit);
    logger::info("finish hook OnAttackIsBlocked"sv);
  }

  static auto is_blocked(RE::Actor* target,
                         RE::Actor* attacker,
  ...
  static auto is_blocking_in_hit(RE::Actor* blocker) -> bool;
  static inline REL::Relocation<decltype(is_blocking_in_hit)> is_blocking_in_hit_;
};

struct OnAllowCharacterMagickaRegen final
{
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnAllowCharacterMagickaRegen"sv);
    is_allow_magicka_regen_ = trampoline.write_call<5>(Adresses::on_allow_character_magicka_regen.address() +
                                                           Offsets::on_allow_character_magicka_regen,
                                                       is_allow_magicka_regen);
    logger::info("finish hook OnAllowCharacterMagickaRegen"sv);
  }

  static auto is_allow_magicka_regen(RE::Character* caster) -> bool;
  static inline REL::Relocation<decltype(is_allow_magicka_regen)> is_allow_magicka_regen_;
};
...
struct OnSendHudMessage final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnSendHudMessage"sv);
    hud_message_ =
        trampoline.write_call<5>(Adresses::on_send_hud_message.address() + Offsets::on_send_hud_message, hud_message);
    logger::info("finish hook OnSendHudMessage"sv);
  }

  private:
  static auto hud_message(RE::UIMessageQueue* this_,
                          const RE::BSFixedString& menu_name,
                          RE::UI_MESSAGE_TYPE message_type,
                          RE::IUIMessageData* message_data) -> void;
  static inline REL::Relocation<decltype(hud_message)> hud_message_;
};

struct OnApplyVoiceAbility final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnApplyVoiceAbility"sv);
    direct_apply_spell_on_target_ = trampoline.write_call<5>(
        Adresses::on_apply_voice_ability.address() + Offsets::on_apply_voice_ability, direct_apply_spell_on_target);
    logger::info("finish hook OnApplyVoiceAbility"sv);
  }

  private:
  static auto direct_apply_spell_on_target(RE::ActorMagicCaster* other_caster,
                                           RE::MagicItem* ability,
                                           RE::TESObject* null_target,
                                           RE::TESBoundObject* null_object,
                                           bool false_value) -> bool;
  static inline REL::Relocation<decltype(direct_apply_spell_on_target)> direct_apply_spell_on_target_;
};
...
struct OnModifyActorValue final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    absorb_effect_modify_actor_value_ = Adresses::on_absorb_effect_modify_actor_value.write_vfunc(
        Offsets::on_absorb_effect_modify_actor_value, modify_actor_value);
  ...
  static auto modify_actor_value(RE::ValueModifierEffect* this_, RE::Actor* actor, float value, RE::ActorValue av)
      -> void;
  static auto absorb_effect_modify_actor_value(RE::ValueModifierEffect* this_,
                                               RE::Actor* actor,
                                               float value,
  ...
  static inline REL::Relocation<decltype(absorb_effect_modify_actor_value)> absorb_effect_modify_actor_value_;
...
struct OnAnimationEvent final
{
  ...
  static auto install_hook() -> void
  {
    ...
    process_event_npc_ =
        Adresses::on_animation_event_npc.write_vfunc(Offsets::on_animation_event_npc, process_event_npc);
    logger::info("finish hook on_animation_event"sv);
  }

  private:
  static auto process_event_pc(RE::BSTEventSink<RE::BSAnimationGraphEvent>* this_,
                               RE::BSAnimationGraphEvent* event,
                               RE::BSTEventSource<RE::BSAnimationGraphEvent>* dispatcher) -> void;
  static auto process_event_npc(RE::BSTEventSink<RE::BSAnimationGraphEvent>* this_,
                                RE::BSAnimationGraphEvent* event,
                                RE::BSTEventSource<RE::BSAnimationGraphEvent>* dispatcher) -> void;
...
struct OnGetBowPower final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hoon OnGetBowPower"sv);
    get_bow_power_ =
        trampoline.write_call<5>(Adresses::on_get_bow_power.address() + Offsets::on_get_bow_power, get_bow_power);
    logger::info("OnGetBowPower hook install"sv);
  }

  private:
  static auto get_bow_power(float draw_power, float weapon_speed) -> float;
  static inline REL::Relocation<decltype(get_bow_power)> get_bow_power_;
};
...
struct OnCalculateCurrentCost final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook OnCalculateCurrentCost"sv);
    calculate_current_cost_conc_ = trampoline.write_call<5>(
        Adresses::on_calculate_current_cost_concentration.address() + Offsets::on_calculate_current_cost_concentration,
        calculate_current_cost_conc);
    logger::info("OnCalculateCurrentCost hook install"sv);
  }

  private:
  static auto calculate_current_cost_conc(RE::ActorMagicCaster* caster) -> float;
  static inline REL::Relocation<decltype(calculate_current_cost_conc)> calculate_current_cost_conc_;
};

struct OnSneakRequirementForSneakAttack final
{
  public:
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    logger::info("start hook on_sneak_requirement_for_sneak_attack"sv);
    is_sneaking_ = trampoline.write_call<5>(Adresses::on_sneak_requirement_for_sneak_attack.address() +
                                                Offsets::on_sneak_requirement_for_sneak_attack,
                                            is_sneaking);
    logger::info("on_sneak_requirement_for_sneak_attack hook install"sv);
  }

  private:
  static auto is_sneaking(RE::Actor* target) -> bool;
  static inline REL::Relocation<decltype(is_sneaking)> is_sneaking_;
};
...
struct OnCastActorValue final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    actor_value_for_cost_check_cast_ = trampoline.write_call<5>(Adresses::on_actor_value_for_cost_check_cast.address() +
    ...
    actor_value_for_cost_during_cast_ = trampoline.write_call<5>(
        Adresses::on_actor_value_for_cost_during_cast.address() + Offsets::on_actor_value_for_cost_during_cast,
        actor_value_for_cost_during_cast);
    actor_value_for_cost_restore_value_ = trampoline.write_call<5>(
        Adresses::on_actor_value_for_cost_restore_value.address() + Offsets::on_actor_value_for_cost_restore_value,
        actor_value_for_cost_restore_value);
    logger::info("OnCastActorValue hook install"sv);
  }

  private:
  static auto actor_value_for_cost_check_cast(RE::MagicItem* magic_item, RE::MagicSystem::CastingSource cast_source)
      -> RE::ActorValue;
  static auto actor_value_for_cost_during_cast(RE::MagicItem* magic_item, RE::MagicSystem::CastingSource cast_source)
      -> RE::ActorValue;
  static auto actor_value_for_cost_restore_value(RE::MagicItem* magic_item, RE::MagicSystem::CastingSource cast_source)
      -> RE::ActorValue;
  static inline REL::Relocation<decltype(actor_value_for_cost_check_cast)> actor_value_for_cost_check_cast_;
  static inline REL::Relocation<decltype(actor_value_for_cost_during_cast)> actor_value_for_cost_during_cast_;
  static inline REL::Relocation<decltype(actor_value_for_cost_restore_value)> actor_value_for_cost_restore_value_;
};
...
struct OnTrapHit final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    trap_hit_ =
        trampoline.write_call<5>(Adresses::on_trap_apply_damage.address() + Offsets::on_trap_apply_damage, trap_hit);
...
struct OnMeleeCollision final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    melee_collision_ =
        trampoline.write_call<5>(Adresses::on_melee_collision.address() + Offsets::on_melee_collision, melee_collision);
    logger::info("OnMeleeCollision hook install"sv);
  }

  private:
  static auto melee_collision(RE::Actor* attacker, RE::Actor* victim, RE::Projectile* projectile, char aleft) -> void;
...
struct OnHealthMagickaStaminaRegeneration final
{
  ...
  static auto install_hook(SKSE::Trampoline& trampoline) -> void
  {
    ...
    restore_stamina_ = trampoline.write_call<5>(
        Adresses::on_regeneration_stamina.address() + Offsets::on_regeneration_stamina, restore_stamina);
    restore_health_ = trampoline.write_call<5>(
        Adresses::on_regeneration_health.address() + Offsets::on_regeneration_health, restore_health);
    restore_magicka_ = trampoline.write_call<5>(
        Adresses::on_regeneration_magicka.address() + Offsets::on_regeneration_magicka, restore_magicka);
...
struct OnCheckResistance final
{
  ...
  static auto install_hook() -> void
  {
    ...
    check_resistance_npc_ =
        Adresses::on_check_resistance_npc.write_vfunc(Offsets::on_check_resistance_npc, check_resistance_npc);
    check_resistance_pc_ =
        Adresses::on_check_resistance_pc.write_vfunc(Offsets::on_check_resistance_pc, check_resistance_pc);
    logger::info("finish hook OnCheckResistance"sv);
  }

  private:
  static auto check_resistance_npc(RE::MagicTarget* this_,
                                   RE::MagicItem* magic_item,
                                   RE::Effect* effect,
                                   RE::TESBoundObject* bound_object) -> float;
  static auto check_resistance_pc(RE::MagicTarget* this_,
                                  RE::MagicItem* magic_item,
                                  RE::Effect* effect,
                                  RE::TESBoundObject* bound_object) -> float;
...
struct OnEnchIgnoresResistance final
{
  ...
  static auto install_hook() -> void
  {
    ...
    ignores_resistance_ =
        Adresses::on_ench_ignores_resistance.write_vfunc(Offsets::on_ench_ignores_resistance, ignores_resistance);
...
struct OnEnchGetNoAbsorb final
{
  ...
  static auto install_hook() -> void
  {
    ...
    get_no_absorb_ = Adresses::on_ench_get_no_absorb.write_vfunc(Offsets::on_ench_get_no_absorb, get_no_absorb);
...
struct OnActorValueOwner final
{
  ...
  static auto set_actor_value_npc(RE::ActorValueOwner* this_, RE::ActorValue av, float value) -> void;
  static auto mod_actor_value_npc(RE::ActorValueOwner* this_, RE::ActorValue av, float value) -> void;

  static auto get_actor_value_pc(RE::ActorValueOwner* this_, RE::ActorValue av) -> float;
  static auto set_actor_value_pc(RE::ActorValueOwner* this_, RE::ActorValue av, float value) -> void;
  static auto mod_actor_value_pc(RE::ActorValueOwner* this_, RE::ActorValue av, float value) -> void;
