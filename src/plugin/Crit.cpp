...
auto crit(RE::Actor& agressor, RE::Actor& target, float& damage, RE::ActorValue crit_chance_av,
          RE::ActorValue crit_damage_av, std::int32_t crit_damage_high, bool physical_crit,
