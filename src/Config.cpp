...
Config::WeaponCritConfig::WeaponCritConfig(toml::table& tbl, RE::TESDataHandler& data_handler,
                                           const Config& config) {
...
Config::ResistTweaksConfig::ResistTweaksConfig(toml::table& tbl, RE::TESDataHandler& data_handler,
                                               const Config& config) {
