...
Config::MagicShieldConfig::MagicShieldConfig(
    toml::table& tbl,
  ...
  if (enable_)
    {
      ...
      const auto must_or_not_effect_keyword_form_id =
          tbl[MagicShield][KeywordId].value<RE::FormID>();
...
Config::PetrifiedBloodConfig::PetrifiedBloodConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::CheatDeathConfig::CheatDeathConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      mgef_percent_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          effect_percent_keyword_form_id.value(),
          config.mod_name());
...
Config::VampirismConfig::VampirismConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_) { av_ = static_cast<RE::ActorValue>(tbl[Vampirism][ActorValueIndex].value_or(120)); }
  ...
  if (mgef_health_enable_)
    {
      ...
      mgef_health_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          effect_vampirism_health_keyword_form_id.value(),
          config.mod_name());
    }
  ...
  if (mgef_stamina_enable_)
    {
      ...
      mgef_stamina_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          effect_vampirism_stamina_keyword_form_id.value(),
          config.mod_name());
    }
  ...
  if (mgef_magicka_enable_)
    {
      ...
      mgef_magicka_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          effect_vampirism_magicka_keyword_form_id.value(),
          config.mod_name());
    }
}

Config::MagicVampirismConfig::MagicVampirismConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::SpeedCastingConfig::SpeedCastingConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      global_ = data_handler.LookupForm<RE::TESGlobal>(
          speed_casting_global_form_id.value(),
          config.mod_name());
...
Config::WeaponCritConfig::WeaponCritConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      keyword_immun_ =
          data_handler.LookupForm<RE::BGSKeyword>(immun_keyword_form_id.value(), config.mod_name());
    }
}

Config::MagickCritConfig::MagickCritConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
    ...
    if (enable_)
      {
        ...
        keyword_immun_ = data_handler.LookupForm<RE::BGSKeyword>(
            immun_keyword_form_id.value(),
            config.mod_name());
...
Config::CastOnCritConfig::CastOnCritConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if ((config.weapon_crit().enable() || config.magick_crit().enable()) && enable_)
    {
      ...
      formlist_needkw_ = data_handler.LookupForm<RE::BGSListForm>(
          form_keywords_form_id.value(),
          config.mod_name());
      formlist_spells_ =
...
Config::CastOnHitConfig::CastOnHitConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::CastOnBlockConfig::CastOnBlockConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::CastOnBlockParryConfig::CastOnBlockParryConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      const auto form_keywords_form_id =
          tbl[CastOnBlockParry][FormListKeywordId].value<RE::FormID>();
...
Config::CastOnTimingBlockConfig::CastOnTimingBlockConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::CastOnParryBashConfig::CastOnParryBashConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      const auto form_keywords_form_id =
          tbl[CastOnParryBash][FormListKeywordId].value<RE::FormID>();
...
Config::CastOnKillConfig::CastOnKillConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::ResourceManagerConfig::ResourceManagerConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      unarmed_weapon_ = data_handler.LookupForm<RE::TESObjectWEAP>(
          unarmed_weapon_form_id.value(),
          config.mod_name());

      health_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          health_keyword_form_id.value(),
          config.mod_name());
      stamina_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          stamina_keyword_form_id.value(),
          config.mod_name());
      magicka_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          magicka_keyword_form_id.value(),
          config.mod_name());

      convert_stamina_health_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_stamina_health_form_id.value(),
          config.mod_name());
      convert_stamina_magicka_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_stamina_magicka_form_id.value(),
          config.mod_name());
      convert_health_stamina_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_health_stamina_form_id.value(),
          config.mod_name());
      convert_health_magicka_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_health_magicka_form_id.value(),
          config.mod_name());
      convert_magicka_stamina_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_magicka_stamina_form_id.value(),
          config.mod_name());
      convert_magicka_health_kw_ = data_handler.LookupForm<RE::BGSKeyword>(
          convertion_keyword_magicka_health_form_id.value(),
          config.mod_name());
    }
}

Config::TkDodgeConfig::TkDodgeConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      spell_add_when_casting_ = data_handler.LookupForm<RE::SpellItem>(
          spell_add_when_casting_form_id.value(),
          config.mod_name());
      ...
      mag_fail_sound_ =
          data_handler.LookupForm<RE::BGSSoundDescriptorForm>(mag_fail_form_id, skyrim);
    }
}

Config::MagicWeaponConfig::MagicWeaponConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      const auto formlist_keywords_form_id =
          tbl[MagicWeapon][FormListKeywordId].value<RE::FormID>();
      ...
      keywords_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_keywords_form_id.value(),
          config.mod_name());
      spells_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_spells_form_id.value(),
          config.mod_name());
      globals_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_globals_form_id.value(),
          config.mod_name());
    }
}

Config::ResistTweaksConfig::ResistTweaksConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      no_av_damage_resist_penetration_ =
          tbl[ResistTweaks][NoAvDamageResistPenetration].value_or(false);
      penetration_av_ =
          static_cast<RE::ActorValue>(tbl[ResistTweaks][ActorValueIndex].value_or(120));

      const auto keyword_form_id = tbl[ResistTweaks][KeywordId].value<RE::FormID>();
      penetration_kw_ =
          data_handler.LookupForm<RE::BGSKeyword>(keyword_form_id.value(), config.mod_name());
    }
}

Config::TimingBlockConfig::TimingBlockConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      blank_activator_ = data_handler.LookupForm<RE::TESObjectACTI>(
          blank_activator_form_id.value(),
          config.mod_name());
      ...
      parry_immun_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          parry_immun_keyword_form_id.value(),
          config.mod_name());
      ...
      parry_timing_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          parry_timing_keyword_form_id.value(),
          config.mod_name());
      ...
      block_immun_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          block_immun_keyword_form_id.value(),
          config.mod_name());
      ...
      block_timing_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          block_timing_keyword_form_id.value(),
          config.mod_name());
      ...
      parry_stagger_count_keyword_ = data_handler.LookupForm<RE::BGSKeyword>(
          parry_stagger_count_keyword_form_id.value(),
          config.mod_name());
      ...
      parry_sound_ = data_handler.LookupForm<RE::BGSSoundDescriptorForm>(
          parry_sound_form_id.value(),
          config.mod_name());

      const auto block_sound_form_id = tbl[TimingBlock][BlockSoundId].value<RE::FormID>();
      block_sound_ = data_handler.LookupForm<RE::BGSSoundDescriptorForm>(
          block_sound_form_id.value(),
          config.mod_name());
    }
}

Config::EquipLoadConfig::EquipLoadConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      ...
      low_equip_spell_ = data_handler.LookupForm<RE::SpellItem>(
          low_equip_spell_form_id.value(),
          config.mod_name());
      med_equip_spell_ = data_handler.LookupForm<RE::SpellItem>(
          med_equip_spell_form_id.value(),
          config.mod_name());
      hig_equip_spell_ = data_handler.LookupForm<RE::SpellItem>(
          hig_equip_spell_form_id.value(),
          config.mod_name());
    }
}

Config::ParryBashConfig::ParryBashConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
Config::ItemLimitConfig::ItemLimitConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
  ...
  if (enable_)
    {
      const auto formlist_keywords_item_form_id =
          tbl[ItemLimit][FormListKeywordItemId].value<RE::FormID>();
      const auto formlist_keywords_cap_form_id =
          tbl[ItemLimit][FormListKeywordCapId].value<RE::FormID>();
      ...
      keywords_cap_mod_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_keywords_cap_form_id.value(),
          config.mod_name());
      keywords_item_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_keywords_item_form_id.value(),
          config.mod_name());
      globals_ = data_handler.LookupForm<RE::BGSListForm>(
          formlist_globals_form_id.value(),
          config.mod_name());
      auto_restore_block_keyword_ =
          data_handler.LookupForm<RE::BGSKeyword>(keyword_form_id.value(), config.mod_name());
      exclusive_restore_keyword_ =
          data_handler.LookupForm<RE::BGSKeyword>(exclusive_keyword_id.value(), config.mod_name());
      storage_ = data_handler.LookupForm<RE::TESObjectREFR>(
          storage_form_id.value(),
          enderal_enable ? "Skyrim.esm" : config.mod_name());
    }
}

Config::DeathLootConfig::DeathLootConfig(
    toml::table& tbl,
    RE::TESDataHandler& data_handler,
    const Config& config)
{
...
[[nodiscard]] auto Config::get_singleton() noexcept -> const Config&
{
